 ...
 *
 * Каждая стрелочка находится на отдельном "такте", отделенном вертикальной чертой
 * а внизу распологается шкала с длительностью той или иной ноты.
 * Бои отделяются вертикальными верточками слева, а паузы нет.
 *
